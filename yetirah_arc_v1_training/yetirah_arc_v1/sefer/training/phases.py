...
def prepare_fast_program_phase(model, materialize_operators: bool = True) -> None:
    """Freeze v30 algebra and optionally cache the full operator bank."""
    freeze_for_program_phase(model)
    if materialize_operators:
