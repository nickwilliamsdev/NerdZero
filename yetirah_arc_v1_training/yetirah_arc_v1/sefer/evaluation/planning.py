...
from yetirah_arc_v1_training.yetirah_arc_v1.sefer.algebra.rollout import apply_program_actions
from yetirah_arc_v1_training.yetirah_arc_v1.sefer.evaluation.programs import functional_equivalence_rate
