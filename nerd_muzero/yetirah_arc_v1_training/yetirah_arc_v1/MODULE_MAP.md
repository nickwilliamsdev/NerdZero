...
| ARC responsibility | Module |
|---|---|
| ARC configuration | `sefer/config.py::ARCConfig` |
| Grid -> 32-slot substrate / decoder | `sefer/representation/arc_grid.py` |
| arckit episodic meta-dataset | `sefer/tasks/arc_dataset.py` |
| Optional pixel-edit Gym environment | `sefer/tasks/arc_env.py` |
| Low-rank adaptation of frozen v30 operator bank | `sefer/algebra/adaptive_operator_bank.py` |
| Demonstration-conditioned ARC reasoner | `sefer/controllers/arc_reasoner.py` |
| ARC three-stage trainer | `sefer/training/arc_trainer.py` |
| ARC exact/pixel/shape evaluation | `sefer/evaluation/arc.py` |
| ARC experiment assembly | `sefer/experiments/arc_v1.py` |
| Training CLI | `run_arc_v1.py` |
| Evaluation CLI | `eval_arc_v1.py` |
| No-arckit fake-data smoke test | `arc_smoke_test.py` |

The original synthetic v30 modules and runners remain available unchanged as regression tests.
